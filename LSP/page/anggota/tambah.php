...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="nim" name="nim" type="number" placeholder="Masukan Nim"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="tempat_lahir" name="tempat_lahir" type="text" placeholder="Masukan Tmpat Lahir"/>
    </div>
    <div class="form-group">
